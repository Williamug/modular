...
it('creates a controller within a module', function () {
  ...
  $controllerPath = base_path('Modules/TestModule/app/Http/Controllers/TestController.php');

  // Ensure the module directory exists
  $filesystem->ensureDirectoryExists(base_path('Modules/TestModule/app/Http/Controllers'));
